package cn.com.cre.smothview.view;
...
public class SmoothImageView extends PhotoView
{
    ...
    private void initView(Context context)
    {
        ...
        mPaint = new Paint();
        mBgColor = ContextCompat.getColor(context, R.color.transparent);
        mPaint.setColor(mBgColor);
        mPaint.setStyle(Style.FILL);
        mOriginalLocationX = CommonUtils.getScreenWidth(context) / 2;
        mOriginalLocationY = CommonUtils.getScreenHeight1(context) / 2;
